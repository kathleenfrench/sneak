...
// TextEditorInputAndSave launches a temporary file with a text editor, captures the input on save, and removes the tmp file while closing the editor - see map saved to EditorLaunchCommands
func TextEditorInputAndSave(label string, defaultText string, editor string) string {
	...
	prompt := &survey.Editor{
		...
		HideDefault:   true,
		Editor:        editor,
		Help:          "enter text, save it, and the program will handle the rest",
	}
